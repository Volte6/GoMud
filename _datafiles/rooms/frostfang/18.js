...
function onCommand_look(rest, user, room) {
    ...
    if ( matches.found ) {
        ...
        SendRoomMessage(room.RoomId(), "<ansi fg=\"username\">"+user.GetCharacterName()+"</ansi> examines the altar.");   
    ...
    if ( matches.found ) {
        ...
        SendRoomMessage(room.RoomId(), "<ansi fg=\"username\">"+user.GetCharacterName()+"</ansi> examines the tapestries.");
