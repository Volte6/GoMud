...
function onEnd(actor, triggersLeft) {
    SendUserMessage(actor.UserId(),     '<ansi fg="buff-text">The healing aura fades.</ansi>')
    SendRoomMessage(actor.GetRoomId(),  `<ansi fg="buff-text">The healing aura around `+actor.GetCharacterName(true)+' fades.</ansi>', actor.UserId())
}
